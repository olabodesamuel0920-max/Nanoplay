-- 20260707000005_remove_service_role_bypass.sql
-- Remove service_role bypass from public.create_payout_request_atomic and public.purchase_tier_with_wallet_atomic
